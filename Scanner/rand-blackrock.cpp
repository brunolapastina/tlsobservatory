...
/***************************************************************************
 ***************************************************************************/
BlackRock::BlackRock( uint64_t range, uint64_t seed, unsigned rounds) noexcept
{
    ...
    switch (range) {
        ...
        default:
            this->range = range;
            this->a = (uint64_t)(foo - 2);
            this->b = (uint64_t)(foo + 3);
            break;
    }
...
/***************************************************************************
 ***************************************************************************/
uint64_t BlackRock::shuffle(uint64_t m) const noexcept
{
    uint64_t c;

    c = ENCRYPT(this->rounds, this->a, this->b, m, this->seed);
    while (c >= this->range)
        c = ENCRYPT(this->rounds, this->a, this->b,  c, this->seed);
...
/***************************************************************************
 ***************************************************************************/
uint64_t BlackRock::unshuffle(uint64_t m) const noexcept
{
    uint64_t c;

    c = UNENCRYPT(this->rounds, this->a, this->b, m, this->seed);
    while (c >= this->range)
        c = UNENCRYPT(this->rounds, this->a, this->b,  c, this->seed);
